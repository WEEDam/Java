...
public class szemSzam_Gui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Személyi szám Vizsgáló"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String beker = jTextField1.getText();
        if (beker.length() > 11 || beker.length() < 11) {
            jLabel1.setText("Érvénytelen személyi szám");
        } else {
            ...
            if (osszeg % 11 == utolso) {
                jLabel1.setText("Érvényes személyi szám.");
            } else {
                jLabel1.setText("Érvénytelen személyi szám.");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(szemSzam_Gui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new szemSzam_Gui().setVisible(true);
            }
        });
    }
